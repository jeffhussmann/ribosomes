...
class RibosomeProfilingExperiment(map_reduce.MapReduceExperiment):
    ...
    def __init__(self, **kwargs):
        ...
        specific_results_files = [
            ...
            ('metacodon_counts_stringent', 'read_positions', '{name}_metacodon_counts_stringent.hdf5'),
            ('metacodon_counts_nucleotide_resolution', 'read_positions', '{name}_metacodon_counts_nucleotide_resolution.hdf5'),
